...
public class SubmitInspectConfigBaselineVersionApi extends PrivateApiComponentBase {
    ...
    public String getToken() {
        return "inspect/config/baseline/version/submit";
    }
    ...
    @Description(desc = "提交巡检配置基线版本审核")
    @Override
    public Object myDoService(JSONObject paramObj) throws Exception {
        JSONObject result = new JSONObject();
        result.put("version", inspectConfigCompareService.submitBaselineVersionForApproval(paramObj.getLong("id")));
        return result;
    }
}
